...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.rating'
        db.alter_column(u'music_album', 'rating', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Album.spotify_url'
        db.alter_column(u'music_album', 'spotify_url', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Album.rating'
        db.alter_column(u'music_album', 'rating', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Album.spotify_url'
        db.alter_column(u'music_album', 'spotify_url', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        u'music.album': {
            ...
            'spotify_url': ('django.db.models.fields.CharField', [], {'max_length': '128'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CityGuideArticle.neighborhood'
        db.add_column(u'prime_cityguidearticle', 'neighborhood',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['prime.Neighborhood']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CityGuideArticle.neighborhood'
        db.delete_column(u'prime_cityguidearticle', 'neighborhood_id')

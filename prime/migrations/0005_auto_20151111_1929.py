    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type', models.CharField(max_length=10, choices=[(b'ARTICLE', b'prime_article'), (b'CITYGUIDE', b'prime_cityguide'), (b'DIYARTICLE', b'prime_diy'), (b'RECIPE', b'prime_recipe')])),
            ],
        ),
        migrations.CreateModel(
            name='PrimeArticle',

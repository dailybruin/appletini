...
from prime.views import CGView, DistrictView, DIYView, RecipeView, IssueView, ArticleView, RecipeFrontView, DIYFrontView, LandingView, RecipeTagsView, DIYTagsView, PastIssuesView, SearchResultView

urlpatterns = patterns('',
    url(r'^$', LandingView.as_view(), name='root'),
    url(r'^search/$', SearchResultView.as_view(), name='search_result'),
